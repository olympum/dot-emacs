...

;;;### (autoloads (ac-nrepl-setup) "ac-nrepl" "ac-nrepl.el" (20589
;;;;;;  16450))
...
(defvar ac-source-nrepl '((candidates . ac-nrepl-candidates) (available . ac-nrepl-available-p) (candidate-face . ac-nrepl-candidate-face) (selection-face . ac-nrepl-selection-face) (prefix . ac-nrepl-symbol-start-pos) (symbol . "n") (document . ac-nrepl-documentation)) "\
...
;;;***

;;;### (autoloads nil nil ("ac-nrepl-pkg.el") (20589 16450 406475))
